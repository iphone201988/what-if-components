  ...
  return (
    <div className='blur-bg min-h-[100vh] relative bg-black py-[60px] max-lg:py-[40px]'>
      <div className="my-container relative">
        ...
        <h2 className='text-grad text-[52px] font-medium max-lg:text-[36px] max-md:text-[24px]'>Login to continue your story</h2>
    ...
    <div className="p-[40px] max-md:p-[20px]">
        ...
        <a href="#" className='text-[16px] block text-center text-[#1DE2FD] mt-[-20px]'>Forgot your password?</a>
        <button className='btn-pri mx-auto mt-[40px]'>Login <img src={arrow} alt="" /></button>
    </div>
        </div>
        <span className='text-[20px] block text-center text-[#B026FF] mt-[20px]'> Don’t have an account? <a href="#" className='text-[#1DE2FD]'>[Sign Up]</a></span>
      </div>
    </div>
  )
}
